...
meta:
  ...
  - name: description
    content: Personal health can be a bore, so why not make it fun?
  - property: og:image
    content: /images/blog/metagame.png
...
<video src="/videos/gen2-metagame.mp4" muted autoPlay playsInline loop className="w-full" />

# {frontmatter.title}

_Author: <a href="https://twitter.com/myconull" target="_blank" rel="noopener noreferrer">myconull</a>_

> The fungi non-human intelligence and humanity have been in a cold war. And until the early 2020s, humanity was losing. - metagame lore
